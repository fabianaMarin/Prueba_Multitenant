...
$ResourceGroupName = "<Prueba_Multitenant>" # the resource group used when the Wingtip SaaS application was deployed. CASE SENSITIVE
$User              = "<fm1>"         # the User value entered when the Wingtip SaaS application was deployed
